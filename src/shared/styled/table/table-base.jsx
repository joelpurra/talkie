...
export const tbody = styled(tableBase.tbody)("tbody");
export const tr = styled(tableBase.tr)("tr");
export const th = styled(tableBase.th)("th");
export const td = styled(tableBase.td)("td");

...
const storageVersion = "v1.1.0";

export const getPersistKeyPrefix = (pagePath) => {
...
export const loadStateSync = (keys, pagePath) => {
    const localStorageKeyPrefix = getPersistKeyPrefix(pagePath);

...
export default function(initialState, rootReducer, sharedStateStorageKeyWhitelist, pagePath) {
    ...
    const whitelist = sharedStateStorageKeyWhitelist;
    const keyPrefix = getPersistKeyPrefix(pagePath);

...
log:false,
logError:false,
onlyLastCallerContinueSpeakingProvider:false,
promiseSeries:false,
promiseTry:false,
SpeechSynthesisUtterance:false,
splitTextToParagraphs:false,
splitTextToSentencesOfMaxLength:false,
*/

const MAX_UTTERANCE_TEXT_LENGTH = 100;

const getSynthesizer = () => promiseTry(
    () => {
...
api.speak = {
    getSynthesizer,
    detectLanguagesAndSpeakAllSelections,
    speakTextInLanguage,
    speakTextInVoice,
    speakUserSelection,
    splitAndSpeak,

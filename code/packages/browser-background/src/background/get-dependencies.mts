...
import DynamicEnvironmentProvider from "@talkie/split-environment/dynamic-environment.mjs";
import InternalUrlProvider from "@talkie/split-environment/internal-url-provider.mjs";
import LocaleProvider from "@talkie/split-environment/locale-provider.mjs";
import ManifestProvider from "@talkie/split-environment/manifest-provider.mjs";
import StorageProvider from "@talkie/split-environment/storage-provider.mjs";
import TranslatorProvider from "@talkie/split-environment/translator-provider.mjs";

...
export interface EditionsDispatchProps {
	storeIsPremiumEdition: typeof actions.shared.metadata.storeIsPremiumEdition;
}

interface EditionsProps extends EditionsStateProps, EditionsDispatchProps {}

export default class Editions<P extends EditionsProps> extends React.PureComponent<P> {

...
import App from "@talkie/demo-application/containers/app";
import rootReducer, {
	actions,
} from "@talkie/demo-application/slices/index";
import {
	DemoRootState,
} from "@talkie/demo-application/store/index";
import {
...
const renderReactHtml: IRenderReactHtmlToFile<DemoRootState, any, ComponentProps<typeof App>> = {
	ChildComponent: App,
